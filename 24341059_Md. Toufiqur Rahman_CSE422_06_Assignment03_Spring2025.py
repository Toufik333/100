...
def drawRain():
    ...
    glColor3f(0.7, 0.7, 0.9)  # Light blue for day
...
def showScreen():
    ...
    for i in range(10):
        shift = 50*i
        a,b,c,d,e,f = 5+shift,280, 10+shift,310, 15+shift,280
        drawTriangle(a,b,c,d,e,f, (113/255, 156/255, 39/255))
        #drawTriangle(5,280, 10,310, 15,280, (0, 0, 0))
    
    drawTriangle(250, 325, 150, 275, 350, 275, (207/255, 145/255, 23/255)) 
...
def rain_animation(value):
    ...
    if is_raining:
        ...
        for (x, y) in raindrops:
            # Update raindrop position with angle
            new_x = x + math.sin(rain_direction_angle) * 2.0
            new_y = y - 7.0  # Rain falls downward
            
            # If raindrop goes out of bounds, reset it
            if new_y < 0:
                new_y = 500
